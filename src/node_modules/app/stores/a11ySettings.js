...
export const resetGroup = groupId => a11ySettings.update(resetGroupItems(groupId));

// CSS property formatting and application
...
const cssPropsUsing = formatters => setting => 
	setting.id in formatters && formatters[setting.id](setting.value);

const getTextStyles = _.pipe([
	_.values,
	_.mapWith(cssPropsUsing(textFormatters)),
	_.fromPairs,
])

export const a11yTextStyles = derived(a11ySettings, getTextStyles);
