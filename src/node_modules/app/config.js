export const toolName = 'TOOLNAME'; // TODO Set tool name accordingly
...
// FIXME `<meta name='description' content='...'> appear twice inside the
// the `<head>` in the dev tools and are not updated upon internal navigation.
