...
<script>
	...
	import {getTruthyValuesKeys} from '@svizzle/utils/object-array';
	...
	const getClasses = _.pipe([getTruthyValuesKeys, _.joinWith(' ')]);
	...
	function resizing () {
		...
		measures.classes = getClasses(measures.size);
