<script>
	...
	// $: isNotNil(currentValue) && updateCurrentValue(currentValue);

	$: console.log('currentValue', $currentSetting.value);
			...
			<div class='controlContainer'>
				{#each $currentSetting.values as value, index}
					<div>
						...
						<input
							name='input-{index}'
							checked={$currentSetting.value.toString() === value}
							on:change={({target: {value}}) => updateCurrentValue(value)}
							type='radio'
							{value}
						>
					</div>
