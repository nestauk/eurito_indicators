<script>
	...
	$: formattedValues = _.map(settingValues, $_formatValue);
	$: useRadios = 
		_.reduce(mapToStringLengths(formattedValues), _.sum, 0) *
		screen?.glyph.width * 1.2 < menuWidth;
...
<dialog class={screen?.classes}>
	...
	<menu bind:clientWidth={containerWidth}>
