...
from eurito_indicators.getters.cord.grid_orm import Institute
from eurito_indicators.getters.cord.grid_orm import Base as GridBase
from eurito_indicators.getters.cord.mag_orm import FieldOfStudy
from eurito_indicators.getters.cord.mag_orm import Base as MagBase
from eurito_indicators.getters.cord.orm_utils import merge_metadata
